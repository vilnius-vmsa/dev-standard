...
<!-- VER-SEM-P01 | ai-reviewable | stacks=all | enforced-by=ai -->
...
<!-- VER-API-P01 | ai-reviewable | stacks=php | enforced-by=ai -->
*   Visos viešos API turi būti versijuojamos
<!-- VER-API-P02 | ai-reviewable | stacks=php | enforced-by=ai -->
...
<!-- VER-API-P03 | ai-reviewable | stacks=php | enforced-by=ai -->
*   API kontraktai turi būti saugomi ir versijuojami kartu su kodu
<!-- VER-API-P04 | ai-reviewable | stacks=php | enforced-by=ai -->
...
<!-- VER-API-R01 | ai-reviewable | stacks=php | enforced-by=ai -->
...
<!-- VER-API-R02 | ai-reviewable | stacks=php | enforced-by=ai -->
*   API versijų nutraukimo (sunset) datos pateikiamos naudojant Sunset ir Deprecation HTTP antraštes
<!-- VER-API-R03 | ai-reviewable | stacks=php | enforced-by=ai -->
...
<!-- VER-PKG-P12 | ai-reviewable | stacks=all | enforced-by=ai -->
...
<!-- VER-PKG-P14 | ai-reviewable | stacks=all | enforced-by=ai -->
...
<!-- VER-SEC-R01 | ai-reviewable | stacks=infra | enforced-by=ai -->
*   SBOM generuoti kiekvienam leidimui ir saugoti kartu su release artefaktais.
<!-- VER-SEC-R02 | ai-reviewable | stacks=all | enforced-by=ai -->
